...
CREATE TABLE `competition` (
  ...
  KEY `MemberID` (`MemberID`),
  CONSTRAINT `competition_ibfk_1` FOREIGN KEY (`MemberID`) REFERENCES `members` (`MemberID`)
...
CREATE TABLE `competition_details` (
  ...
  CONSTRAINT `competition_details_ibfk_1` FOREIGN KEY (`CompetitionID`) REFERENCES `competition` (`CompetitionID`),
  CONSTRAINT `competition_details_ibfk_2` FOREIGN KEY (`SwimArtID`) REFERENCES `swimart` (`SwimArtID`),
  CONSTRAINT `competition_details_ibfk_3` FOREIGN KEY (`SwimDistID`) REFERENCES `swimdist` (`SwimDistID`),
  CONSTRAINT `competition_details_ibfk_4` FOREIGN KEY (`genderid`) REFERENCES `gender` (`GenderID`)
...
-- Dump completed on 2019-11-28  8:08:55
